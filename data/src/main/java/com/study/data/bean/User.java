...
public class User extends Entity {
  ...
  @Deprecated public final static int RELATION_TYPE_BOTH = 0x01;// 双方互为粉丝
  @Deprecated public final static int RELATION_TYPE_FANS_HIM = 0x02;// 你单方面关注他
  @Deprecated public final static int RELATION_TYPE_NULL = 0x03;// 互不关注
  @Deprecated public final static int RELATION_TYPE_FANS_ME = 0x04;// 只有他关注我
