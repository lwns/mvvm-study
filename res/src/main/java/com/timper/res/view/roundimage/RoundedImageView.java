package com.timper.res.view.roundimage;

/**
 * Created by chengjun.liu.o on 2017/12/8.
 */
 ...
 * @author caizhiming
 */
@SuppressLint("AppCompatCustomView") public class RoundedImageView extends ImageView {
  ...
  private void updateAttrs(Drawable drawable, ScaleType scaleType) {
    ...
    if (drawable instanceof RoundedDrawable) {
      ...
      if (mCornerRadii != null) {
        ((RoundedDrawable) drawable).setCornerRadius(mCornerRadii[Corner.TOP_LEFT], mCornerRadii[Corner.TOP_RIGHT],
            mCornerRadii[Corner.BOTTOM_RIGHT], mCornerRadii[Corner.BOTTOM_LEFT]);
      }
