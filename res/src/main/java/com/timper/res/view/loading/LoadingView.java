...
public class LoadingView extends View {
  ...
  private static final LoadingIndicator DEFAULT_INDICATOR = new LoadingIndicator();
  ...
  public LoadingView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs, 0, R.style.App_Theme_Loading);
  }

  public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(context, attrs, defStyleAttr, R.style.App_Theme_Loading);
  }
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    mMinWidth = a.getDimensionPixelSize(R.styleable.loading_minWidth, mMinWidth);
    mMaxWidth = a.getDimensionPixelSize(R.styleable.loading_maxWidth, mMaxWidth);
    mMinHeight = a.getDimensionPixelSize(R.styleable.loading_minHeight, mMinHeight);
    mMaxHeight = a.getDimensionPixelSize(R.styleable.loading_maxHeight, mMaxHeight);
    String indicatorName = a.getString(R.styleable.loading_indicatorName);
    mIndicatorColor = a.getColor(R.styleable.loading_indicatorColor, Color.WHITE);
  ...
  @TargetApi(Build.VERSION_CODES.LOLLIPOP) @Override public void drawableHotspotChanged(float x, float y) {
