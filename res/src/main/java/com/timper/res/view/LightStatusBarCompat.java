...
public class LightStatusBarCompat {
    ...
    if (MIUILightStatusBarImpl.isMe()) {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
        IMPL = new MLightStatusBarImpl() {
          ...
          @Override public void setLightStatusBar(Window window, boolean lightStatusBar) {
  ...
  private static class MLightStatusBarImpl implements ILightStatusBar {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) @Override public void setLightStatusBar(Window window, boolean lightStatusBar) {
      // 设置浅色状态栏时的界面显示
