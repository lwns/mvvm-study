package com.timper.res.bindingadapter.viewpager;
...
public class ViewBindingAdapter {
  ...
  public static void setIndex(final ViewPager viewPager, final Integer position) {
    if (viewPager != null && viewPager.getAdapter() != null && position >= 0) viewPager.setCurrentItem(position);
  }
  ...
  public static void setPageLimit(final ViewPager viewPager, final Integer pageLimit) {
    if (viewPager != null) viewPager.setOffscreenPageLimit(pageLimit);
  }

  @BindingAdapter(value = {
      "onPageScrolledCommand", "onPageSelectedCommand", "onPageScrollStateChangedCommand"
  }, requireAll = false)
  public static void onScrollChangeCommand(final ViewPager viewPager, final Command<ViewPagerDataWrapper> onPageScrolledCommand,
      final Command<Integer> onPageSelectedCommand, final Command<Integer> onPageScrollStateChangedCommand) {
